        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-danger" href="/laporan/siswa">
                        <i class="fa fa-print"></i> Siswa PDF
                    </a>
                    <a class="btn btn-primary btn-info" href="{{ route('siswa.export') }}">
                        <i class="fa fa-print"></i> Siswa Excel
                    </a>
                </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-success"
                                                href="{{ route('siswa.edit', ['siswa' => $item->nisn]) }}">
