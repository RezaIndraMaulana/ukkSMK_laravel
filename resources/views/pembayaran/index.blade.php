        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-danger" href="/laporan/pembayaran">
                        <i class="fa fa-print"></i> Pembayaran PDF
                    </a>
                    <a class="btn btn-primary btn-info" href="{{ route('pembayaran.export') }}">
                        <i class="fa fa-print"></i> Pembayaran Excel
                    </a>
                </div>
                <div class="card-body">
