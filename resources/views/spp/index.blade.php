        ...
        <div class="col-12"> 
            <div class="card"> 
                <div class="card-header"> 
                    ...
                    <a class="btn btn-primary btn-danger" href="/laporan/spp">
                        <i class="fa fa-print"></i> SPP PDF
                    </a>
                    <a class="btn btn-primary btn-info" href="{{ route('spp.export') }}">
                        <i class="fa fa-print"></i> SPP Excel
                    </a>
                </div> 
