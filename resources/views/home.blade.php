            ...
            <div class="card">
                <div class="card card-widget widget-user">
                    <div class="widget-user-header text-white"
                        style="background: url('gambar/cool-background.jpg') center center; background-size:cover;">
                    ...
                    <div class="widget-user-image">
                        <img class="img-circle" src="gambar/man.jpg">
                    </div>
        ...
        <div class="col-6">
            <div class="card">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-image">
                        <img class="img-circle" src="gambar/woman.jpg">
                    </div>
                    <div class="card-footer">
